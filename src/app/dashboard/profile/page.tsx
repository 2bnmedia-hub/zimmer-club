...
export default function EditProfilePage() {
  ...
  async function handleAvatarChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      showToast('success', 'תמונת הפרופיל עודכנה בהצלחה')
    } catch {
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]" dir="rtl">
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-5 py-3 rounded-2xl shadow-xl text-sm font-medium transition-all
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-100 border-2 border-[#C4956A]/30">
                {avatarPreview ? (
                  <img src={avatarPreview} alt="פרופיל" className="w-full h-full object-cover" />
                ) : (
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Phone className="w-3.5 h-3.5" />טלפון</span>
              </label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Mail className="w-3.5 h-3.5" />אימייל</span>
              </label>
              <input
                type="email"
