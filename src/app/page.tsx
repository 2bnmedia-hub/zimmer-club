...
export default function HomePage() {
  return (
    <>
      ...
      <main>
        {/* HERO */}
        <section className="relative min-h-[55vh] pt-24 flex flex-col items-center justify-center text-center px-4 py-8 overflow-hidden bg-transparent">
...
/>
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            {/* Subtitle */}
            <p className="text-sm lg:text-base text-taupe max-w-xl mx-auto mb-6 leading-relaxed" style={{fontFamily: "'Caveat', cursive", fontSize: "1.3rem"}}>
