    ...
    <div className="border-t border-gray-100 pt-6 mt-6">
      ...
      <div className="bg-gray-50 rounded-2xl p-5">
        ...
        <div className="flex items-center justify-between mb-3">
          <button type="button" onClick={nextMonth} aria-label="החודש הבא" className="p-1.5 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center min-w-11 min-h-11"><IconChevronRight className="w-4 h-4 text-gray-500" /></button>
          <span className="font-bold text-gray-800 text-sm">{HEBREW_MONTHS[currentMonth]} {currentYear}</span>
          <button type="button" onClick={prevMonth} aria-label="החודש הקודם" className="p-1.5 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center min-w-11 min-h-11"><IconChevronLeft className="w-4 h-4 text-gray-500" /></button>
        </div>
