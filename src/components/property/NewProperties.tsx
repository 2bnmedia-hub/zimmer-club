    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-3" style={{ height: '520px' }}>
          ...
          {p0 && (
            <Link href={p0.slug ? `/properties/${p0.slug}` : `/property/${p0.id}`} className="col-span-1 row-span-2 group relative rounded-2xl overflow-hidden" style={{ boxShadow: '0 4px 32px rgba(0,0,0,0.10)', gridColumn: '3', gridRow: '1 / span 2' }}>
